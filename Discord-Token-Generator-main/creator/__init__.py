...
from creator.utils import, generatePassword, generateUsername

def create( emailAPI, phoneAPI, proxy=True, username=True, verbose:bool=False):
    start = time.time()
    ...
    session.register(captchaKey, accountEmail.email, password, username)
